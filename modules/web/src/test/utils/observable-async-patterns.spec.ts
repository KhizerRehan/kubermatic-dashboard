...
describe('Observable and Async Patterns', () => {
  ...
  describe('Multiple Subscriptions Pattern', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        declarations: [MultipleSubscriptionsComponent],
  ...
  describe('Hot vs. Cold Observables', () => {
    ...
    it('should receive initial values from all observables', fakeAsync(() => {
      ...
      expect(component.coldValue).toBe(1);
      expect(component.hotValue).toBe(0);
      expect(component.sharedValue).toBe(1);
    }));
  ...
  describe('Error Recovery Patterns', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        declarations: [ErrorRecoveryComponent],
        teardown: {destroyAfterEach: false},
      }).compileComponents();
    ...
    it('should attempt retry multiple times on failure', fakeAsync(() => {
      fixture.detectChanges();

      component.emitValue('fail');
      tick(100);
      fixture.detectChanges();

      // Should have attempted retries
      expect(component.attemptCount).toBeGreaterThan(0);
    }));

    it('should show error after max retries exceeded', fakeAsync(() => {
      fixture.detectChanges();
      ...
      expect(component.error).toContain('Temporary failure');
    }));
  });
  ...
  describe('Timing Patterns with fakeAsync', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        declarations: [TimingPatternsComponent],
        teardown: {destroyAfterEach: false},
      }).compileComponents();
    ...
    it('should handle flush to complete all pending timers', fakeAsync(() => {
      fixture.detectChanges();
      ...
      // Should have emitted multiple values
  ...
  describe('Subscription Cleanup and Memory Leak Prevention', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        declarations: [SubscriptionCleanupComponent],
        teardown: {destroyAfterEach: false},
      }).compileComponents();
    ...
    it('should unsubscribe all subscriptions on destroy', fakeAsync(() => {
      ...
      const spy1 = spyOn(subscriptions[0], 'unsubscribe');
      const spy2 = spyOn(subscriptions[1], 'unsubscribe');
  ...
  describe('Complex Observable Chains', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        declarations: [ObservableChainsComponent],
        teardown: {destroyAfterEach: false},
      }).compileComponents();
  ...
  describe('Advanced Async Patterns', () => {
    ...
    it('should handle multicast with publish pattern', fakeAsync(() => {
      ...
      const sub1 = source$.subscribe(val => results1.push(val));
      tick(100);
      const sub2 = source$.subscribe(val => results2.push(val));
